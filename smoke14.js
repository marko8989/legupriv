...
function splat(x, y, dx, dy, color) {
  ...
  // Adjusting the color here to make sure it's a consistent shade of purple
  gl.uniform3f(splatProgram.uniforms.color, 0.529 * 0.75, 0.357 * 0.75, 1.0 * 0.75);
  blit(density.write[1]);
  density.swap();
}
